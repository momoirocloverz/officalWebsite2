...
<script>
  export default {
    ...
    data() {
      return {
        arr: [
          { name: '关于我们', path: '/aboutUs',isWhite:1,index:0 },
          { name: '资质认证', path: '/aboutUs/certification',isWhite:1,index:1 },
          { name: '联系我们', path: '/aboutUs/contactUs',isWhite:1,index:2 }
        ],
      }
    },
      mounted(){
