<template>
  <div class="classManagerCon"> 
       <div class="limitWidth">
            <div class="contentCon">
                <div class="imgCon"><img class="bigImg" src="@/assets/img/person_ui.png"></div>
                <div class="rightSide">
                    <div class="title">万才个人版</div>
                    <div class="secondLine">适用人群：中国4亿新业态从业人员</div>
                    <div class="bottomCon">
                    ...
                    <div class="qrcodeSwitchCon">
                        <div class="qrcodeImgSwitchCon" >
                            ...
                            <img v-else src="@/assets/img/iosPersonal.png">
                        </div>
                    </div>
                    </div>
                </div>
...
//        this.getLink();
    ...
    methods:{
        getLink(){
            this.ApiLists.getAndroidLinks(2).then(res=>{
